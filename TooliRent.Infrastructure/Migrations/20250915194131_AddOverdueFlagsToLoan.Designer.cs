...
namespace TooliRent.Infrastructure.Migrations
{
    ...
    [Migration("20250915194131_AddOverdueFlagsToLoan")]
    partial class AddOverdueFlagsToLoan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TooliRent.Domain.Entities.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TooliRent.Domain.Entities.LoanItem", b =>
                {
            ...
            modelBuilder.Entity("TooliRent.Infrastructure.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TooliRent.Infrastructure.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TooliRent.Domain.Entities.LoanItem", b =>
                {
                    b.HasOne("TooliRent.Domain.Entities.Loan", "Loan")
                        .WithMany("Items")
